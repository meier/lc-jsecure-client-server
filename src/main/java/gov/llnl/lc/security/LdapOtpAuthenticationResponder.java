 ...
 *
 *        file: LdapOtpAuthenticationResponder.java
 *
...
public class LdapOtpAuthenticationResponder extends AbstractAuthenticationResponder implements AuthenticationResponder, AuthenticationConstants, CommonLogger
{
  ...
  public boolean requestAuthentication(BufferedReader in, PrintWriter out, String uname, String passcode) throws IOException
  {
    /* FIXME break out if Server sends something other than expected response */
    boolean done = false;
    String fromServer;
